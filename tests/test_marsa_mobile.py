# -*- coding: utf-8 -*-
"""Tests for `marsa_mobile` package."""

import random

import pytest

from marsa_mobile import marsa_mobile
...
def test_sum_numbers(generate_numbers):
    ...
    our_result = marsa_mobile.sum_numbers(generate_numbers)
...
def test_max_number(generate_numbers):
    ...
    our_result = marsa_mobile.max_number(generate_numbers)
